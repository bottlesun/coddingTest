...
* 사과의 최대 점수 k, 한 상자에 들어가는 사과의 수 m, 사과들의 점수 score 가 주어졌을 때,
* 과일 장수가 얻을 수 있는 최대 이익을 return 하는 solution 함수를 완성해주세요.
 ...
 *     arr.push(score.sort((a, b) => b - a).slice(i, i + m));
 *    }
 * 
 *    for (let i of arr) {
 *   if (i.length === m) answer.push(i[i.length - 1] * m)
 *   }
 * 
